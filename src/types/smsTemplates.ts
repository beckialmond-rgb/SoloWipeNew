    ...
    templates: [
      {
        ...
        name: 'Professional',
        isDefault: true,
        message: 'Hi {{customer_firstName}}, just a quick reminder that I\'m scheduled to clean your windows at {{customer_addressLine1}} on {{scheduled_date}}. Please ensure I have access to all windows. Total for service: £{{job_total}}. - {{business_name}}',
      },
      {
        id: 'casual',
        name: 'Casual',
        message: 'Hey {{customer_firstName}}! Quick reminder - I\'ll be cleaning your windows at {{customer_addressLine1}} on {{scheduled_date}}. Total: £{{job_total}}. Thanks! - {{business_name}}',
      },
      {
        id: 'friendly',
        name: 'Friendly',
        message: 'Hi {{customer_firstName}}, just letting you know I\'ll be at yours on {{scheduled_date}} for the window clean at {{customer_addressLine1}}. Total for service: £{{job_total}}. See you then! 😊 - {{business_name}}',
      },
    ],
  },
  receipt: {
    ...
    templates: [
      ...
      },
      {
        id: 'casual',
        name: 'Casual',
        message: 'Hey {{customer_firstName}}! Window clean all done at {{customer_addressLine1}}. Total: £{{job_total}}. Payment: {{payment_method}}.{{photo_url}} Cheers! - {{business_name}}',
      },
      {
        id: 'friendly',
        name: 'Friendly',
    ...
    templates: [
      {
        ...
        name: 'Professional',
        isDefault: true,
        message: 'Hi {{customer_firstName}}, {{business_name}} here. Just a friendly reminder about your window clean from {{completed_date}}. Amount due: £{{job_total}}. Thanks so much!',
      },
      {
        id: 'casual',
        name: 'Casual',
        message: 'Hey {{customer_firstName}}, just a reminder about your window clean from {{completed_date}}. Amount due: £{{job_total}}. Thanks! - {{business_name}}',
      },
      {
        id: 'friendly',
        name: 'Friendly',
        message: 'Hi {{customer_firstName}}, hope you\'re well! Just a quick reminder about the window clean from {{completed_date}}. Amount due: £{{job_total}}. Thanks! 😊 - {{business_name}}',
      },
    ],
  },
  rain_check: {
    ...
    templates: [
      {
        ...
        name: 'Professional',
        isDefault: true,
        message: 'Hi {{customer_firstName}}, due to rising material and fuel costs, your window clean price will increase to £{{new_price}} starting from your next visit. Your current price is £{{current_price}}. Thank you for your continued support! - {{business_name}}',
      },
      {
        id: 'casual',
        name: 'Casual',
      ...
      },
      {
        id: 'friendly',
        name: 'Friendly',
        message: 'Hi {{customer_firstName}}, hope you\'re well! Due to costs going up, the price will be £{{new_price}} from your next clean (currently £{{current_price}}). Thanks so much for your continued support! 😊 - {{business_name}}',
      },
    ],
  },
  referral: {
    ...
    templates: [
      {
        ...
        name: 'Professional',
        isDefault: true,
        message: 'Hi {{customer_firstName}}, I\'m offering your friends and family their first window clean FREE! Share this code {{referral_code}} with them. They can text me with their name, address, and phone number to claim their free clean. - {{business_name}}',
      },
      {
        id: 'casual',
        name: 'Casual',
        message: 'Hey {{customer_firstName}}! Got a deal for your friends and family - first window clean is FREE! Share code {{referral_code}} with them. They just need to text me their name, address, and phone number. Let\'s grow together! - {{business_name}}',
      },
      {
        id: 'friendly',
        name: 'Friendly',
        message: 'Hi {{customer_firstName}}! 🎉 Special offer - your friends and family get their first window clean completely FREE! Share code {{referral_code}} with them. They can reply with their name, address, and phone number. Thanks for spreading the word! - {{business_name}}',
      },
    ],
  },
  general: {
